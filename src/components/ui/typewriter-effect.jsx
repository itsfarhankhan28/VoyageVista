            ...
            <div key={`word-${idx}`} className="inline-block">
              {word.text.map((char, index) => (
                <motion.span
                  initial={{}}
                  key={`char-${index}`}
                  className="dark:text-black text-black opacity-0 hidden"
                >
                  {char}
                </motion.span>
              ))}
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="inline-block rounded-sm w-[4px] h-4 md:h-6 lg:h-10 bg-black"
      ></motion.span>
    </div>
  );
};
  ...
  return (
    <div className="flex space-x-1 my-6">
      ...
      <motion.span
        ...
        className="block rounded-sm w-[4px]  h-4 sm:h-6 xl:h-10 bg-black"
      ></motion.span>
    </div>
  );
};
